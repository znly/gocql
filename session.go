...
func (q *Query) attempt(keyspace string, end, start time.Time, iter *Iter, conn *Conn) {
	if gocqlDebug {
...
func (b *Batch) attempt(keyspace string, end, start time.Time, iter *Iter, conn *Conn) {
	b.attempts++
